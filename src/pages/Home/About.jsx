...
function About() {
  return (
    <>
      ...
      <Headers />
      <BreadcrumbComponent props={[{ name: "Giới thiệu", url: "/gioi-thieu" }]} />
      <Container className="my-3">
        ...
        <Row className="my-4">
          ...
          <Col lg={6}>
            <img src="https://dkdecor.vn/wp-content/uploads/2024/01/Screenshot-2024-01-16-163647.jpg" alt="Hair Salon" className="img-fluid rounded shadow-lg" />
          </Col>
        </Row>

        <Row className="my-5">
          <h3 className="fw-bold text-primary-emphasis text-center mb-4">Dịch vụ của chúng tôi</h3>
          <Col md={4}>
        ...
        <div className="container my-5">
          <div className="row align-items-center">
            <div className="col-lg-6 text-center pb-4">
              <img src="https://static.30shine.com/shop-web/banners/Banner3_2-T1023-6.jpg" alt="Sản phẩm chăm sóc" className="img-fluid rounded shadow-lg" />
            </div>
        ...
        <Row
          ...
          style={{
            backgroundImage: "url('https://dkdecor.vn/wp-content/uploads/2024/01/Screenshot-2024-01-16-163647.jpg')",
          }}
        >
          <Col>
