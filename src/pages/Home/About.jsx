          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              ...
              <ul className="list-unstyled">
                <li className="border-bottom py-2 fs-5">
                  Dầu gội và dầu xả cao cấp
                </li>
                <li className="border-bottom py-2 fs-5">
                  Kem dưỡng và tinh chất phục hồi
                </li>
                <li className="py-2 fs-5">Sản phẩm tạo kiểu tóc</li>
              </ul>
              ...
              <ul className="list-unstyled">
                <li className="border-bottom py-2 fs-5">Sữa rửa mặt dịu nhẹ</li>
                <li className="border-bottom py-2 fs-5">
                  Kem dưỡng ẩm hàng ngày
                </li>
                <li className="py-2 fs-5">Kem chống nắng bảo vệ da</li>
              </ul>
            </div>
          </div>
        </div>
